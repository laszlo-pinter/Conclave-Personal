...
const I18N = {
  de: {
    ...
    'autoloop.rotation': 'Antwortreihenfolge',
    'autoloop.rotationNone': 'Statisch',
    'autoloop.rotationRoundRobin': 'Rotierend',
    'autoloop.rotationHint': 'Rotierend verschiebt den ersten Agenten pro Runde um eine Position.',
    ...
    'autoloop.tooManyParticipants': 'Maximal 20 Participants pro Auto-Loop.',
    'autoloop.invalidRounds': 'Max. Runden muss zwischen 1 und 50 liegen.',
    'autoloop.invalidStopSignal': 'Stop-Signal muss 1 bis 128 Zeichen lang sein.',
  ...
  en: {
    ...
    'autoloop.rotation': 'Response order',
    'autoloop.rotationNone': 'Static',
    'autoloop.rotationRoundRobin': 'Rotating',
    'autoloop.rotationHint': 'Rotating shifts the first agent by one position each round.',
    ...
    'autoloop.tooManyParticipants': 'Maximum 20 participants per auto-loop.',
    'autoloop.invalidRounds': 'Max rounds must be between 1 and 50.',
    'autoloop.invalidStopSignal': 'Stop signal must be 1 to 128 characters long.',
